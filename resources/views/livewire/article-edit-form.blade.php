<div>
    <form class="shadow p-5 rounded" wire:submit.prevent="update">
        @csrf
        ...
        <div class="mb-3">
            ...
            <textarea id="body" wire:model="body" cols="30" rows="7" class="form-control @error('body') is-invalid @enderror"></textarea>
            @error('body')
                <span class="fst-italic text-danger small">{{$message}}</span>
            @enderror
        </div>
